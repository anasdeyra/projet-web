  ...
  return (
    <div className="mt-36">
      ...
      <div className="flex items-center justify-center gap-8 mt-10 mx-auto">
        <Link
          to={"/services"}
          className="text-lg text-neutral-950 font-semibold bg-gradient-to-bl hover:bg-green-500 from-emerald-700 to-green-500 px-5 py-2 rounded-full transition-all active:scale-[0.98]"
        >
          Join now
        </Link>
        <Link
